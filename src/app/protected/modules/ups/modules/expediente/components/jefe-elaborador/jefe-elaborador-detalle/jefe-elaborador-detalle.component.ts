...
@Component({
  selector: 'app-jefe-elaborador-detalle',
  templateUrl: './jefe-elaborador-detalle.component.html',
  styleUrls: ['./jefe-elaborador-detalle.component.scss']
})
export class JefeElaboradorDetalleComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,public dialogRef: MatDialogRef<JefeElaboradorDetalleComponent>,
