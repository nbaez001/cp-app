...
@Component({
  selector: 'app-observar-devuelto',
  templateUrl: './observar-devuelto.component.html',
  styleUrls: ['./observar-devuelto.component.scss'],
  animations: Animations
})
export class ObservarDevueltoComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ObservarDevueltoComponent>,
  ...
  ngOnInit() {
    ...
    (this.datos.cidEstado === "005" 
     || this.datos.cidEstado === "010" || this.datos.cidEstado === "014" || this.datos.cidEstado === "028")
  ...
  devolver() {
    ...
    if (typeof this.dataSource !== 'undefined' && this.dataSource.data.length > 0) {
     ...
     let parametroDialog: Object = {
      ...
      const dialogMessage: MatDialogRef<ConfirmMessageComponent> = this.dialog.open(ConfirmMessageComponent);
      dialogMessage.componentInstance.message = '¿Está seguro de devolver el proyecto al encargado?';
      dialogMessage.afterClosed().subscribe((confirm: boolean) => {
        if (confirm) {
          this.dialogRef.close(parametroDialog)
