...
@Component({
  selector: 'app-jefe-elaborador-archivo-presupuesto',
  templateUrl: './jefe-elaborador-archivo-presupuesto.component.html',
  styleUrls: ['./jefe-elaborador-archivo-presupuesto.component.scss']
})

export class JefeElaboradorArchivoPresupuestoComponent implements OnInit {
  @ViewChild('myInput')
  ...
  constructor(public dialogRef: MatDialogRef<JefeElaboradorArchivoPresupuestoComponent>,
...
// carga de archivo original
  subirArchivo() {
    ...
    archivoRequest.tipoDoc = this.archivoForm.get('tipoDocArchivoFrmCtrl').value.idCodigo;
    ...
    this.proyectoService.subirArchivo(archivoRequest).pipe(delay(2000)).subscribe(
     ...
     /*    console.log(response);
        ...
        if (response.codResultado == 1) {
          ...
          this.openDialogMensaje(MENSAJES.ARCHIVO_TITLE, null, this.mensaje ,true, false);
          this.listadoArchivo();
          this.reiniciar();
          this.selectedFiles = false;   
