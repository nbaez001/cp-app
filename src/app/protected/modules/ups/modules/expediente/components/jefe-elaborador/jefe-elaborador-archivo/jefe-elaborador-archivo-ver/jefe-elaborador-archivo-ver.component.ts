...
@Component({
  selector: 'app-jefe-elaborador-archivo-ver',
  templateUrl: './jefe-elaborador-archivo-ver.component.html',
  styleUrls: ['./jefe-elaborador-archivo-ver.component.scss']
})

export class JefeElaboradorArchivoVerComponent implements OnInit {
    ...
    constructor(public dialogRef: MatDialogRef<JefeElaboradorArchivoVerComponent>,
