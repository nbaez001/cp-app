...
@Component({
  selector: 'app-jefe-elaborador-archivo-ver-general',
  templateUrl: './jefe-elaborador-archivo-ver-general.component.html',
  styleUrls: ['./jefe-elaborador-archivo-ver-general.component.scss']
})
export class JefeElaboradorArchivoVerGeneralComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<JefeElaboradorArchivoVerGeneralComponent>,
