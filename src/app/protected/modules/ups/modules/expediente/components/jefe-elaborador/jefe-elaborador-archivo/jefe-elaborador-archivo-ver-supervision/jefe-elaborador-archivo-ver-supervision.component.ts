...
@Component({
  selector: 'app-jefe-elaborador-archivo-ver-supervision',
  templateUrl: './jefe-elaborador-archivo-ver-supervision.component.html',
  styleUrls: ['./jefe-elaborador-archivo-ver-supervision.component.scss']
})
export class JefeElaboradorArchivoVerSupervisionComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<JefeElaboradorArchivoVerSupervisionComponent>,
