...
export class ProyectoService{
  ...
  validarDocumentoExcel(idProyecto : number, tipoArchivo: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/validarFile/${idProyecto}/${tipoArchivo}`, null);
  }
  ...
  visualizarArchivoExcelPresupuesto(fidProyecto: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFilePresupuesto/${fidProyecto}`,null);
  }

  visualizarArchivoExcelPartida(fidProyecto: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFilePrecioUnitario/${fidProyecto}`,null);
  }

  visualizarArchivoExcelGeneral(fidProyecto: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFileGastoGeneral/${fidProyecto}`,null);
  }

  visualizarArchivoExcelSupervision(fidProyecto: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFileGastoSupervision/${fidProyecto}`,null);
  }
 /* FIN VISUALIZAR ARCHIVOS TEMPORALES DEL PRESUPUESTO*/
  ...
  /* INICIO VISUALIZAR ARCHIVOS FINALES DEL PRESUPUESTO*/
  visualizarArchivoExcelPresupuestoFinal(fidProyecto: number, idPadre: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFileTreePadre/${fidProyecto}/${idPadre}`,null);
  }

  visualizarArchivoExcelPresupuestoFinalHijos(fidProyecto: number, idPadre: number, nivel: string): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/obtenerFileTreeHijoPresupuesto/${fidProyecto}/${idPadre}/${nivel}`,null);
  }

  visualizarArchivoExcelPartidaFinal(fidProyecto: number, idPadre: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFileTreePrecioUnitario/${fidProyecto}/${idPadre}`,null);
  }

  visualizarArchivoExcelGeneralFinal(fidProyecto: number, idPadre: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFileTreeGastoGeneral/${fidProyecto}/${idPadre}`,null);
  }

  visualizarArchivoExcelSupervisionFinal(fidProyecto: number, idPadre: number): Observable<WsApiOutResponse> {
    return this.http.post<WsApiOutResponse>(`${environment.backendUrlProj}/prefactibilidadFile/listarFileTreeGastoSupervision/${fidProyecto}/${idPadre}`,null);
  }

 /* FIN VISUALIZAR ARCHIVOS FINALES DEL PRESUPUESTO*/
